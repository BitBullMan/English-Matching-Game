...
export const STAGES = [
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    id: 'food-1', emoji: '🍎', title: '水果入门', intro: '苹果、香蕉、葡萄',
  ...
  {
    id: 'food-2', emoji: '🥦', title: '蔬菜与谷物', intro: '常见蔬菜、面包',
  ...
  {
    id: 'food-3', emoji: '☕', title: '饮品与餐点', intro: '咖啡、茶、披萨',
    difficulty: 2, group: 'food',
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    id: 'clothing-1', emoji: '👕', title: '衣帽鞋袜', intro: 'T恤、裤、鞋',
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    id: 'transport-1', emoji: '🚗', title: '交通工具', intro: '车、火车、飞机',
    difficulty: 2, group: 'transport',
    picker: (all) => all.filter(w => w.category === 'transport')
  },
  {
    id: 'nature-1', emoji: '☀️', title: '自然万物', intro: '日月星云山',
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    id: 'phrase-greeting', emoji: '👋', title: '问候与寒暄', intro: '你好、再见、谢谢',
    difficulty: 1, group: 'phrase',
    picker: filterByScenario('greeting')
  },
  {
    id: 'phrase-intro', emoji: '🙋', title: '自我介绍', intro: '我叫…、你来自哪？',
    difficulty: 2, group: 'phrase',
    picker: filterByScenario('intro')
  },
  {
    id: 'phrase-time', emoji: '⏰', title: '时间与数字', intro: '几点？今天明天',
    difficulty: 1, group: 'phrase',
    picker: filterByScenario('time')
  },
  {
    id: 'phrase-direction', emoji: '🧭', title: '问路', intro: '在哪里？怎么走？',
    difficulty: 2, group: 'phrase',
    picker: filterByScenario('direction')
  },
  {
    id: 'phrase-transport', emoji: '🚕', title: '出行交通', intro: '打车、地铁、机场',
    difficulty: 2, group: 'phrase',
    picker: filterByScenario('transport')
  },
  {
    id: 'phrase-restaurant', emoji: '🍽️', title: '餐厅点餐', intro: '菜单、推荐、买单',
    difficulty: 2, group: 'phrase',
    picker: filterByScenario('restaurant')
  },
  {
    id: 'phrase-shopping', emoji: '🛍️', title: '购物砍价', intro: '多少钱？便宜点？',
    difficulty: 2, group: 'phrase',
    picker: filterByScenario('shopping')
  },
  {
    id: 'phrase-hotel', emoji: '🏨', title: '酒店入住', intro: 'Check-in、Wi-Fi、退房',
    difficulty: 3, group: 'phrase',
    picker: filterByScenario('hotel')
  },
  {
    id: 'phrase-emergency', emoji: '🆘', title: '紧急求助', intro: '救命、医院、警察',
    difficulty: 2, group: 'phrase',
    picker: filterByScenario('emergency')
  },
  {
    id: 'phrase-polite', emoji: '🙏', title: '礼貌用语', intro: '请、对不起、是的',
    difficulty: 1, group: 'phrase',
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    id: 'vocab-top100', emoji: '📚', title: '高频 1-100', intro: 'Google 词频前 100',
    difficulty: 3, group: 'vocab',
    picker: filterVocabRange(0, 100)
  },
  {
    id: 'vocab-101-200', emoji: '📚', title: '高频 101-200', intro: '常见名词动词',
    difficulty: 3, group: 'vocab',
    picker: filterVocabRange(100, 200)
  },
  {
    id: 'vocab-201-300', emoji: '📚', title: '高频 201-300', intro: '日常常用',
    difficulty: 4, group: 'vocab',
    picker: filterVocabRange(200, 300)
  },
  {
    id: 'vocab-301-400', emoji: '📚', title: '高频 301-400', intro: '进阶词汇',
    difficulty: 4, group: 'vocab',
    picker: filterVocabRange(300, 400)
  },
  {
    id: 'vocab-401-500', emoji: '📚', title: '高频 401-500', intro: '挑战级',
...
export const STAGE_GROUPS = [
  { id: 'food',      label: '🍎 食物', color: '#ff8c42' },
  { id: 'home',      label: '🏠 家居', color: '#6fc6ff' },
  { id: 'animal',    label: '🐼 动物', color: '#a3d36a' },
  { id: 'clothing',  label: '👕 服饰', color: '#b076ff' },
  { id: 'transport', label: '🚗 交通', color: '#ff7aa8' },
  { id: 'nature',    label: '🌳 自然', color: '#6fb91c' },
  { id: 'body',      label: '🧑 身体', color: '#ffd24a' },
  { id: 'phrase',    label: '💬 旅游短句', color: '#d8395d' },
  { id: 'vocab',     label: '📚 扩展词汇', color: '#9ed838' },
  { id: 'mixed',     label: '🎲 综合挑战', color: '#ff5e9b' }
]
